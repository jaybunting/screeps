...
module.exports.loop = function () {
    ...
    for (var eachroom in roomlist) {
        ...
        Game.getObjectById(Game.rooms[roomlist[eachroom]].memory.storage = Game.getObjectById(Game.rooms[roomlist[eachroom]].room.find(FIND_STRUCTURES, { filter: (structure) => { return (structure.structureType == STRUCTURE_STORAGE); }});;
